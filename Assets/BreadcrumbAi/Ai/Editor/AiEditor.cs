		...
		public override void OnInspectorGUI ( ) {
			...
			if ( ai._HasAvoidance ) {
				...
				if ( _showAvoid ) {
					...
					ai.avoidBuildingDistance = EditorGUILayout.Slider( "Avoid Building Distance", ai.avoidBuildingDistance, 0.01f, 100.0f );
					ai.avoidPlayerDistance = EditorGUILayout.Slider( "Avoid Player Distance", ai.avoidPlayerDistance, 0.01f, 100.0f );
